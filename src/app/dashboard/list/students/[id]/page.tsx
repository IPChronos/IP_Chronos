...
const SingleStudentPage = async ({
  ...
  const role = (sessionClaims?.metadata as { role?: string })?.role;
    ...
    | (Student & {
        ...
        _count: { joinedExams: number };
      })
    | null = await prisma.student.findUnique({
    where: { id },
    include: {
      class: { include: { _count: { select: { lessons: true } } } },
      _count: { select: { joinedExams: true } },
      specialization: true
    },
  });
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[45%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">USV</span>
              </div>
            </div>
            {/* CARD */}
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[45%]">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[45%]">
              ...
              <div className="">
                <h1 className="text-xl font-semibold">
                  {student._count.joinedExams}
                </h1>
                <span className="text-sm text-gray-400">Joined exams</span>
              </div>
            </div>
          </div>
        </div>
