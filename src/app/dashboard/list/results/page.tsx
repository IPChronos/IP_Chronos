...
const renderRow = (item: ResultList) => {
  if (!item) return null; // Safeguard against null or undefined items
  ...
  .map((item) => {
    ...
    if (!assessment) return null; // Return null if no assessment is found

    const isExam = "startTime" in assessment;

    return {
      id: item.id,
      title: assessment.title, // Access safely because of the early return
