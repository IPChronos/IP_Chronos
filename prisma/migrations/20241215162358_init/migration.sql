...
-- CreateIndex
CREATE UNIQUE INDEX "Specialization_level_key" ON "Specialization"("level");
...
-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_specializationId_fkey" FOREIGN KEY ("specializationId") REFERENCES "Specialization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
